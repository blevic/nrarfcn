...
class TestTablesLoader(unittest.TestCase):
    def test_get_supported_releases(self):
        ...
        self.assertIn(18, get_supported_releases())
    ...
    def test_get_table(self):
        ...
        table = get_table('bands_fr1', 18)

        self.assertEqual(table.id, 'bands_fr1')
        self.assertEqual(table.release_3gpp, 18)
    ...
    def test_api_release_argument(self):
        ...
        self.assertEqual(get_frequency(0, release_3gpp=18), 0.0)
